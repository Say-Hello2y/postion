...
/*************求取航迹偏差（计算的是第三个输入地点至第一二个输入地点的航迹偏差）*************************///////////////////////////////
...
struct lat lat_shanghai={31,11,0};//上海纬度
struct lng lng_dalian={121,36,9};//大连精度
struct lng lng_shanghai={121,29,0};//上海经度
struct lat lat_yantai={37,52,0};//烟台纬度
struct lng lng_yantai={121,39,0};//烟台经度
